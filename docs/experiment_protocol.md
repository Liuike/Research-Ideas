...
submit the arrays. Slurm retains ignored per-task stdout and stderr files under
`logs/slurm/` in the Oscar project root for failure diagnosis; experiment metrics
and reproducibility metadata remain in W&B.
