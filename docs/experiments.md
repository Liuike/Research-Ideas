...
| `exploratory-2xl40s-tests-v1` | Reduced qualitative probes for Gates A-C | [`configs/exploratory/gates_2xl40s.yaml`](../configs/exploratory/gates_2xl40s.yaml) | `exploratory-2xl40s-tests-v1` | 30 runs | Running | Oscar array `6117578`, tasks 8-37, revision `7964bb7`; exploratory only, and two seeds cannot establish formal gate passage. |
| `exploratory-2xl40s-lr-scout-v1` | Equal three-candidate LR scout at one anchor per track | [`configs/exploratory/lr_scout_2xl40s.yaml`](../configs/exploratory/lr_scout_2xl40s.yaml) | `exploratory-2xl40s-lr-scout-v1` | 24 runs | Queued after test cells | Oscar array `6117578`, tasks 38-61; dependent CPU recipe selection is job `6117579`. |
| `exploratory-2xl40s-boundary-v1` | Two-seed ShapeSet-depth and Latch-length signal check using scout-selected recipes | [`configs/exploratory/boundary_mlp_2xl40s.yaml`](../configs/exploratory/boundary_mlp_2xl40s.yaml), [`configs/exploratory/boundary_rnn_2xl40s.yaml`](../configs/exploratory/boundary_rnn_2xl40s.yaml) | `exploratory-2xl40s-boundary-v1` | 32 runs | Queued with dependency | Oscar array `6117580` waits on recipe-selection job `6117579`; `%2` and `l40s` are enforced. |
